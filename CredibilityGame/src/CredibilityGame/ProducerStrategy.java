...
public class ProducerStrategy implements Strategy{
	...
	public ProducerStrategy(Producer producer){
		/*
		 * TODO: Dodaæ losowanie wg rozk³adów!!!
		 */
		this.truthfulness = RandomHelper.createUniform(Producer.getProducerTypeL(), Producer.getProducerTypeH()).nextInt()>0?1.0:0.0;//producer.isHonest()?1:0;
