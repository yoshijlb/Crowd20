...
public class ProducerStrategyType {
	...
	public int getProducerTypeLow(){
		return Producer.getProducerTypeL();
	}
	
	public int getProducerTypeHigh(){
		return Producer.getProducerTypeH();
	}
	
	public int getConsumerTypeLow(){
		return Consumer.getConsumerTypeL();
	}
	
	public int getConsumerTypeHigh(){
		return Consumer.getConsumerTypeH();
	}
	...
	public double getAvgConsumerGain(){
		...
		double sum = 0;
		int counter = 0;
		for(Player c:context.getObjects(Consumer.class)){
			sum += c.getGain();
			counter++;
		}
		return sum/counter;
	...
	public double getAvgProducerGain(){
		...
		double sum = 0;
		int counter = 0;
		for(Player c:context.getObjects(Producer.class)){
			sum += c.getGain();
			counter++;
		}
		return sum/counter;
	...
	public double getAverageReputationThreshold(){
		...
		int counter = 0;
		for(Player c:context.getObjects(Consumer.class)){
			sum += ((AcceptanceStrategy)(((Consumer)c).getStrategy())).getReputationThreshold();
			counter++;
		}
		return sum/counter;
	}
	...
	public double getAverageRating(){
		...
		double sum = 0;
		int counter = 0;
		for(Player p:context.getObjects(Producer.class)){
			sum += ((Producer)p).getCurrentRating().getRatingAsDouble();
			counter++;
		}
		return sum/counter;
	}
	...
	public double getAverageSignalThreshold(){
		...
		int counter = 0;
		for(Player c:context.getObjects(Consumer.class)){
			sum += ((AcceptanceStrategy)(((Consumer)c).getStrategy())).getThreshold();
			counter++;
		}
		return sum/counter;
	}
	...
	public double getAverageSignal(){
		...
		int counter = 0;
		for(Player c:context.getObjects(Consumer.class)){
			sum += ((AcceptanceStrategy)(((Consumer)c).getStrategy())).getSignal();
			counter++;
		}
		return sum/counter;
	}
	...
	public double getAverageExpertSignalThreshold(){
		...
		int counter = 0;
		for(Player c:context.getObjects(Consumer.class)){
			if(((Consumer)c).getExpertise()<0.16){
				sum += ((AcceptanceStrategy)(((Consumer)c).getStrategy())).getThreshold();
				counter++;
			}
		}
	...
	public double getAverageNonExpertSignalThreshold(){
		...
		int counter = 0;
		for(Player c:context.getObjects(Consumer.class)){
			if(((Consumer)c).getExpertise()>=0.66){
				sum += ((AcceptanceStrategy)(((Consumer)c).getStrategy())).getThreshold();
				counter++;
			}
		}
	...
	public int getAcceptanceBySignalStrategy(){
		...
		int sum = 0;
		for(Player c:context.getObjects(Consumer.class)){
			if(((AcceptanceStrategy)((Consumer)c).getStrategy()).getAcceptanceStrategy() == 0){
				sum ++;
			}
		}
		return sum;
	...
	public int getAcceptanceByReputationStrategy(){
		...
		int sum = 0;
		for(Player c:context.getObjects(Consumer.class)){
			if(((AcceptanceStrategy)((Consumer)c).getStrategy()).getAcceptanceStrategy() == 1){
				sum ++;
			}
		}
		return sum;
	...
	public int getAcceptanceByReputationAndSignalStrategy(){
		...
		int sum = 0;
		for(Player c:context.getObjects(Consumer.class)){
			if(((AcceptanceStrategy)((Consumer)c).getStrategy()).getAcceptanceStrategy() == 2){
				sum ++;
			}
		}
		return sum;
	...
	public int getAcceptanceByReputationOrSignalStrategy(){
		...
		int sum = 0;
		for(Player c:context.getObjects(Consumer.class)){
			if(((AcceptanceStrategy)((Consumer)c).getStrategy()).getAcceptanceStrategy() == 3){
				sum ++;
			}
		}
		return sum;
